...
void CPCBArc::Parse(wxXmlNode *aNode, int aLayer, wxString aDefaultMeasurementUnit, wxString aActualConversion) {
    wxXmlNode *lNode;
    double r, a;
...
void CPCBArc::WriteToFile(wxFile *aFile, char aFileType) {
/*
