...
void CPCBPolygon::FormPolygon(wxXmlNode *aNode, CVerticesArray *aPolygon,
    wxString aDefaultMeasurementUnit, wxString aActualConversion)
{
    ...
    while (lNode) {
        if (lNode->GetName() == wxT("pt")) {
            SetDoublePrecisionPosition(lNode->GetNodeContent(), aDefaultMeasurementUnit, &x, &y, aActualConversion);
...
void CPCBPolygon::WriteOutlineToFile(wxFile *aFile, char aFileType) {
    int i, island;
    char c;
...
void CPCBPolygon::SetPosOffset(int aX_offs, int aY_offs) {
    int i, island;

    CPCBComponent::SetPosOffset(aX_offs, aY_offs);
