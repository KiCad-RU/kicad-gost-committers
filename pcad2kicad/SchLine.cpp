...
void CSchLine::Parse(wxXmlNode *aNode, int aSymbolIndex,
...
void CSchLine::WriteToFile(wxFile *aFile, char aFileType) {
    wxString lt;
...
void CSchLine::WriteLabelToFile(wxFile *aFile, char aFileType) {
    char lr;
