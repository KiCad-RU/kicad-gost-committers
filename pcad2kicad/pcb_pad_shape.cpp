...
PCB_PAD_SHAPE::PCB_PAD_SHAPE(PCB_CALLBACKS *aCallbacks) : PCB_COMPONENT(aCallbacks) {
...
void PCB_PAD_SHAPE::Parse(wxXmlNode *aNode, wxString aDefaultMeasurementUnit, wxString aActualConversion) {
    wxString str, s;
    long num;
