...
void CPCBLine::Parse(wxXmlNode *aNode, int aLayer, wxString aDefaultMeasurementUnit, wxString aActualConversion) {
    wxXmlNode *lNode;
    wxString propValue;
...
void CPCBLine::WriteToFile(wxFile *aFile, char aFileType) {
