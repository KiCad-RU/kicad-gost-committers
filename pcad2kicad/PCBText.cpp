...
void CPCBText::Parse(wxXmlNode *aNode, int aLayer, wxString aDefaultMeasurementUnit, wxString aActualConversion) {
    wxXmlNode *lNode;
    wxString str;
...
void CPCBText::WriteToFile(wxFile *aFile, char aFileType) {
